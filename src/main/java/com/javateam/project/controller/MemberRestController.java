...
//	} //
	...
	public ResponseEntity<String> emailUpdate(@RequestParam("id") String id,
		...
		try {
			...
			// 이메일 수정 성공할 경우(200)
			// 200(성공): 서버가 요청을 제대로 처리했다는 뜻이다. 이는 주로 서버가 요청한 페이지를 제공했다는 의미로 쓰인다.
			if (memberService.updateMemberByAdmin(id, "email", email) == true) {
	...
	public ResponseEntity<String> phoneUpdate(@RequestParam("id") String id,
		...
		try {
			...
			// 연락처 수정 성공할 경우(200)
			// 200(성공): 서버가 요청을 제대로 처리했다는 뜻이다. 이는 주로 서버가 요청한 페이지를 제공했다는 의미로 쓰인다.
			if (memberService.updateMemberByAdmin(id, "phone", phone) == true) {
												    ...
												    @RequestParam("address2") String address2) 
	{
		...
		try {
			...
			// 200(성공): 서버가 요청을 제대로 처리했다는 뜻이다. 이는 주로 서버가 요청한 페이지를 제공했다는 의미로 쓰인다.
			if (memberService.updateMemberByAdmin(id, "zip_num", zipNum) == true && 
				memberService.updateMemberByAdmin(id, "address1", address1) == true && 
				memberService.updateMemberByAdmin(id, "address2", address2) == true) 
			{
												 ...
												 @RequestParam("address2") String address2) 
	{
		...
		try {
			...
			// 상세주소 수정 성공할 경우(200)
			// 200(성공): 서버가 요청을 제대로 처리했다는 뜻이다. 이는 주로 서버가 요청한 페이지를 제공했다는 의미로 쓰인다.
			if (memberService.updateMemberByAdmin(id, "address2", address2) == true) 
			{
